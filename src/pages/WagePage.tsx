...
const WagePage = () => {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ["wage", startDate, endDate, page, PAGE_SIZE, divisionId],
    queryFn: () => wageApi.getAll({ startDate, endDate, page, pageSize: PAGE_SIZE, divisionId: divisionId || undefined }),
